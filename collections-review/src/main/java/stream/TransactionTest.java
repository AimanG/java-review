...
public class TransactionTest {
    public static void main(String[] args) {
        ...
        //3-Find all traders from c and sort them by name
        ...
        //6-Print the values of all transactions from the traders living Cambridge
        ...
        //8-Find the transaction wit the smallest value
